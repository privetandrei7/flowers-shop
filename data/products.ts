...
export const products: Product[] = [
  ...
  { id: 'white-cloud', name: 'White Cloud', price: 2790, image: img('https://images.unsplash.com/photo-1618239265038-9e4c865fbd10'), category: 'Букеты', tags: ['Для мамы', 'Спасибо'], description: 'Чистая белая композиция с лёгким, элегантным характером.', composition: 'Белые розы, хризантемы, эвкалипт' },
  ...
  { id: 'garden-box', name: 'Garden Box', price: 2990, image: img('https://images.unsplash.com/photo-1521052424247-a1a47c7de691'), category: 'Цветы в коробке', tags: ['Спасибо', 'Новинки'], description: 'Стильная коробка с сезонными цветами и премиальной подачей.', composition: 'Розы, ранункулюсы, сезонные цветы' },
  { id: 'mini-lumiere', name: 'Mini Lumière', price: 1690, image: img('https://images.unsplash.com/photo-1591529787628-4ed43078e9e6'), category: 'Букеты', tags: ['Просто так'], description: 'Небольшой комплимент без повода — просто чтобы порадовать.', composition: 'Сезонные цветы, зелень' },
  { id: 'royal-roses', name: 'Royal Roses', price: 4490, image: img('https://images.unsplash.com/photo-1705807070861-1cf5591bd567'), category: 'Розы', tags: ['Хиты', 'Розы', 'День рождения'], description: 'Эффектный букет для яркого признания и важных дат.', composition: 'Эквадорские розы, декоративная зелень' },
];
